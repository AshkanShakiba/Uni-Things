...
--
-- Table structure for table `special_service`
--
...
--
-- Dumping data for table `special_service`
--

LOCK TABLES `special_service` WRITE;
/*!40000 ALTER TABLE `special_service` DISABLE KEYS */;
/*!40000 ALTER TABLE `special_service` ENABLE KEYS */;
UNLOCK TABLES;
